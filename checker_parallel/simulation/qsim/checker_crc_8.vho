...
-- Design Ports Information
-- check	=>  Location: PIN_B8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- check_err[0]	=>  Location: PIN_C13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- check_err[1]	=>  Location: PIN_M11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- check_err[2]	=>  Location: PIN_L12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- check_err[3]	=>  Location: PIN_N12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- check_err[4]	=>  Location: PIN_K11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- check_err[5]	=>  Location: PIN_D11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- check_err[6]	=>  Location: PIN_L13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- check_err[7]	=>  Location: PIN_D12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- a[2]	=>  Location: PIN_M7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- a[9]	=>  Location: PIN_N7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- a[10]	=>  Location: PIN_C11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- a[22]	=>  Location: PIN_D10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- a[17]	=>  Location: PIN_F9,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- a[18]	=>  Location: PIN_E13,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- a[12]	=>  Location: PIN_N10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- a[14]	=>  Location: PIN_H10,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- a[20]	=>  Location: PIN_H12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- a[19]	=>  Location: PIN_E10,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- a[15]	=>  Location: PIN_F11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- a[16]	=>  Location: PIN_F13,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- a[6]	=>  Location: PIN_K13,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \error_7|y~2_combout\ : std_logic;
...
-- Equation(s):
-- \error_6|y~1_combout\ = \a[6]~input_o\ $ (\a[11]~input_o\ $ (\a[18]~input_o\ $ (\a[17]~input_o\)))
...
-- Equation(s):
-- \error_6|y~0_combout\ = \a[21]~input_o\ $ (\a[9]~input_o\ $ (\a[14]~input_o\ $ (\a[13]~input_o\)))
...
-- Equation(s):
-- \error_6|y~2_combout\ = \error_6|y~1_combout\ $ (\a[16]~input_o\ $ (\error_6|y~0_combout\ $ (\a[15]~input_o\)))
...
-- Equation(s):
-- \error_3|y~0_combout\ = \a[3]~input_o\ $ (\a[17]~input_o\ $ (\a[8]~input_o\ $ (\a[12]~input_o\)))
...
-- Equation(s):
-- \error_3|y~combout\ = \a[21]~input_o\ $ (\a[16]~input_o\ $ (\error_3|y~0_combout\ $ (\encode_crc8|xor_a_2_1|y~combout\)))
...
-- Equation(s):
-- \error_4|y~0_combout\ = \a[4]~input_o\ $ (\a[11]~input_o\ $ (\a[18]~input_o\ $ (\a[17]~input_o\)))
...
-- Equation(s):
-- \error_4|y~combout\ = \encode_crc8|xor_a_2_1|y~combout\ $ (\a[13]~input_o\ $ (\a[22]~input_o\ $ (\error_4|y~0_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \encode_crc8|xor_a_2_1|y~combout\,
	datab => \a[13]~input_o\,
	datac => \a[22]~input_o\,
	datad => \error_4|y~0_combout\,
	combout => \error_4|y~combout\);

-- Location: LCCOMB_X30_Y23_N12
\check~1\ : cycloneiv_lcell_comb
-- Equation(s):
-- \check~1_combout\ = (\error_6|y~2_combout\) # ((\error_3|y~combout\) # (\error_4|y~combout\))
...
-- Equation(s):
-- \error_2|y~1_combout\ = \a[23]~input_o\ $ (\a[11]~input_o\ $ (\a[8]~input_o\ $ (\a[19]~input_o\)))
...
-- Equation(s):
-- \error_2|y~2_combout\ = \error_2|y~1_combout\ $ (\a[20]~input_o\)
...
-- Equation(s):
-- \error_0|y~0_combout\ = \a[17]~input_o\ $ (\a[16]~input_o\ $ (\a[15]~input_o\ $ (\a[18]~input_o\)))
...
-- Equation(s):
-- \error_0|y~1_combout\ = \error_2|y~2_combout\ $ (\a[13]~input_o\ $ (\a[0]~input_o\ $ (\error_0|y~0_combout\)))
...
PORT MAP (
	...
	datab => \a[13]~input_o\,
	datac => \a[0]~input_o\,
	datad => \error_0|y~0_combout\,
	combout => \error_0|y~1_combout\);

-- Location: LCCOMB_X30_Y23_N0
\error_7|y~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \error_7|y~0_combout\ = \a[12]~input_o\ $ (\a[14]~input_o\ $ (\a[18]~input_o\ $ (\a[17]~input_o\)))
...
-- Equation(s):
-- \error_2|y~0_combout\ = \a[9]~input_o\ $ (\a[2]~input_o\ $ (\a[10]~input_o\))
...
-- Equation(s):
-- \error_2|y~combout\ = \error_2|y~2_combout\ $ (\error_7|y~0_combout\ $ (\a[22]~input_o\ $ (\error_2|y~0_combout\)))
...
-- Equation(s):
-- \error_7|y~1_combout\ = \a[7]~input_o\ $ (\a[16]~input_o\ $ (\a[15]~input_o\ $ (\a[10]~input_o\)))
...
\error_7|y~2\ : cycloneiv_lcell_comb
-- Equation(s):
-- \error_7|y~2_combout\ = \a[19]~input_o\ $ (\error_7|y~0_combout\ $ (\a[22]~input_o\ $ (\error_7|y~1_combout\)))
...
PORT MAP (
	...
	datab => \error_7|y~0_combout\,
	datac => \a[22]~input_o\,
	datad => \error_7|y~1_combout\,
	combout => \error_7|y~2_combout\);

-- Location: LCCOMB_X30_Y24_N20
\check~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \check~0_combout\ = (\error_0|y~1_combout\) # ((\error_2|y~combout\) # (\error_7|y~2_combout\))
...
PORT MAP (
	...
	datab => \error_2|y~combout\,
	datad => \error_7|y~2_combout\,
...
-- Equation(s):
-- \error_1|y~0_combout\ = \a[23]~input_o\ $ (\a[1]~input_o\ $ (\a[11]~input_o\ $ (\a[8]~input_o\)))
...
-- Equation(s):
-- \error_1|y~1_combout\ = \a[12]~input_o\ $ (\error_1|y~0_combout\ $ (\error_6|y~0_combout\ $ (\a[15]~input_o\)))
...
-- Equation(s):
-- \error_5|y~0_combout\ = \a[5]~input_o\ $ (\a[10]~input_o\ $ (\a[15]~input_o\ $ (\a[16]~input_o\)))
...
-- Equation(s):
-- \error_5|y~1_combout\ = \a[12]~input_o\ $ (\a[20]~input_o\ $ (\a[8]~input_o\ $ (\a[17]~input_o\)))
...
-- Equation(s):
-- \error_5|y~2_combout\ = \error_5|y~0_combout\ $ (\a[13]~input_o\ $ (\a[14]~input_o\ $ (\error_5|y~1_combout\)))
...
PORT MAP (
	...
	datab => \a[13]~input_o\,
	datac => \a[14]~input_o\,
	datad => \error_5|y~1_combout\,
	combout => \error_5|y~2_combout\);

-- Location: LCCOMB_X30_Y23_N22
\check~2\ : cycloneiv_lcell_comb
-- Equation(s):
-- \check~2_combout\ = (\check~1_combout\) # ((\check~0_combout\) # ((\error_1|y~1_combout\) # (\error_5|y~2_combout\)))
...
PORT MAP (
	...
	datac => \error_1|y~1_combout\,
	datad => \error_5|y~2_combout\,
